...
class magic_denied extends StatefulWidget {
  const magic_denied({super.key});

  @override
  State<magic_denied> createState() => _magic_deniedState();
}

class _magic_deniedState extends State<magic_denied> {
  @override
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          const Expanded(
                              child: Text(
                            "Unable to match digits please speak again",
